...
type PizzaSpec struct {
	...
	// topping is a list of Topping names. They don't have to be unique. Order does not matter.
	Toppings []string `json:"toppings,omitempty" protobuf:"bytes,1,rep,name=toppings"`
}
