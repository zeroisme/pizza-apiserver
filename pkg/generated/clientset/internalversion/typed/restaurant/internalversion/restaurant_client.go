...
import (
	...
	"github.com/zeroisme/pizza-apiserver/pkg/generated/clientset/internalversion/scheme"
...
// NewForConfigAndClient creates a new RestaurantClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RestaurantClient, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
