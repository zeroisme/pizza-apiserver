...
import (
	...
	clientsetinternalversion "github.com/zeroisme/pizza-apiserver/pkg/generated/clientset/internalversion"
	internalinterfaces "github.com/zeroisme/pizza-apiserver/pkg/generated/informers/internalversion/internalinterfaces"
	internalversion "github.com/zeroisme/pizza-apiserver/pkg/generated/listers/restaurant/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Restaurant().Pizzas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Restaurant().Pizzas(namespace).Watch(context.TODO(), options)
			},
		},
		&restaurant.Pizza{},
		resyncPeriod,
